...
@register_model_architecture('roberta', 'roberta_mid')
def roberta_mid_architecture(args):
...
@register_model_architecture('roberta', 'roberta_xsmall')
def roberta_xsmall_architecture(args):
